...
Dans la zone de recherche, entrez le terme **affichage** pour filtrer la liste de paramètres.

Dans la section **Paramètres de l'écran**, nous recommandons les paramètres suivants :

- Échelle de l'écran externe : **100%**
- Échelle de l'écran interne : **100%**

![Paramètres d'affichage dans Google Admin](/4-touchify-player/3-installation/4-chromeos/fr-player-chrome-admin-affichage.webp)
